...
(function(mod) {
  ...
  function onDragStart(cm, e) {
    ...
    // Recent Safari (~6.0.senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2) have a tendency to segfault when this happens, so we don't do it there.
  ...
  var bidiOrdering = (function() {
    ...
    return function(str) {
      ...
      // levels (0, 1, senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2) in an implementation that doesn't take
