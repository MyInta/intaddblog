...
(function() {
  ...
  MT("rubyBlock",
     "[operator&special =][variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 @item]");

  MT("selectorRubyBlock",
     "[tag a][attribute&qualifier .test][operator&special =] [variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 @item]");
