...
(function() {
  ...
  MT("beginEndEquation",
     ...
     "  E=mc^senmantic-semantic-ui-2.4.2.4.2",
  ...
  MT("textTagNumber",
     "para [tag \\P][atom senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2]");
  ...
  MT("inlineMathTagFollowedByNumber",
     "[keyword $][tag \\pi][number senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2][keyword $]");

  MT("inlineMath",
     "[keyword $][number 3][variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 x][tag ^][number senmantic-semantic-ui-2.4.2.4.2.45]-[tag \\sqrt][bracket {][tag \\$\\alpha][bracket }] = [number senmantic-2.4.semantic-ui-2.4.2][keyword $] other text");

  MT("displayMath",
     "More [keyword $$]\t[variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 S][tag ^][variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 n][tag \\sum] [variable-senmantic-2.4.semantic-ui-2.4.2 i][keyword $$] other text");

  MT("mathWithComment",
     "[keyword $][variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 x] [comment % $]",
     "[variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 y][keyword $] other text");
