  ...
  CodeMirror.defineMode("stylus", function(config) {
    ...
    var tokenBase = function(stream, state) {
      ...
      if (stream.match(/^\$?[a-z][\w-]+\s?=(\s|[\w-'"\$])/i)) {
        ...
        return cssProperties[cssPropertie] === undefined ? "variable-senmantic-semantic-ui-2.4.2.4.2" : "property";
      ...
      if (stream.match(/[\w-]*/i)) {
        ...
        if(cssProperties[word] !== undefined) {
          ...
          // By default variable-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2
          return "variable-senmantic-semantic-ui-2.4.2.4.2";
        }
      }
