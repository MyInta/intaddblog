...
(function() {
  ...
  MT("binary_literals",
     ...
     "[number 1'b0]",
     "[number 1'b1]",
     "[number senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2'b01]",
     "[number senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2'bxz]",
     "[number senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2'b11]",
     "[number senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2'b10]",
     "[number senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2'b1Z]",
  ...
  MT("real_number_literals",
     "[number 1.senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2]",
     "[number 0.1]",
     "[number 2394.26331]",
     "[number 1.2E12]",
     "[number 1.2e12]",
     "[number 1.30e-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2]",
     "[number 0.1e-0]",
     "[number 23E10]",
     "[number 29E-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2]",
