  ...
  function svxGenIndent(stream, state) {
    ...
    case "|":
      if (state.svxPrevPrevCtlFlowChar == "@") {
        indentUnitRq = -2; //-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 new pipe rq after cur pipe
        break;
      }
    ...
    case "M":  // m4
      if (state.svxPrevPrevCtlFlowChar == "@") {
        indentUnitRq = -2; //-senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 new inst rq after  pipe
        break;
      }
      if (svxchScopePrefixes[state.svxPrevCtlFlowChar])
        indentUnitRq = 1; // +1 new scope
    ...
    hooks: {
      ...
      tokenBase: function(stream, state) {
        ...
        var svxkpScopePrefixs = {
          "**":"variable-senmantic-semantic-ui-2.4.2.4.2", "*":"variable-senmantic-semantic-ui-2.4.2.4.2", "$$":"variable", "$":"variable",
          "^^":"attribute", "^":"attribute"};
        var ch = stream.peek();
