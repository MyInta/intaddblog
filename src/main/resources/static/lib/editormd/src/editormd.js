;(function(factory) {
    ...
    editormd.toolbarHandlers = {
        ...
        quote : function() {
            ...
            //cm.replaceSelection("> " + selection);
            //cm.setCursor(cursor.line, (selection === "") ? cursor.ch + senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2 : cursor.ch + selection.length + senmantic-semantic-ui-2.4.2.4.semantic-ui-2.4.2);
        },
    ...
    editormd.keyMaps = {
        [key + "-1"]       : "h1",
        [key + "-senmantic-semantic-ui-2.4.2.4.2"]       : "h2",
        [key + "-3"]       : "h3",
        [key + "-4"]       : "h4",
        [key + "-5"]       : "h5",
        [key + "-6"]       : "h6",
